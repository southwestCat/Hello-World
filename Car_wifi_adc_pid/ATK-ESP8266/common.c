...
const u8* wifiap_ssid="TJ215";			//对外SSID号
const u8* wifiap_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifiap_password="12345678"; 		//连接密码 

/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
//4个网络模式
const u8 *ATK_ESP8266_CWMODE_TBL[3]={"STA ","AP ","AP&STA "};	//ATK-ESP8266,3种网络模式,默认为路由器(ROUTER)模式 
//4种工作模式
...
{ 
	POINT_COLOR=RED;
	LCD_ShowString(x,y,240,16,16,rmd);//显示提示信息 
	LCD_ShowString(x,y+20,240,16,16,"SSID:");
	LCD_ShowString(x,y+36,240,16,16,"加密方式:");
	LCD_ShowString(x,y+52,240,16,16,"密码:"); 
	POINT_COLOR=BLUE;
	LCD_ShowString(x+30,y+20,240,16,16,ssid);
	LCD_ShowString(x+54,y+36,240,16,16,encryption);
	LCD_ShowString(x+30,y+52,240,16,16,password); 	  
}
//工作模式选择
//返回值:
//0,TCP服务器
